  ...
  const stats = analytics
    ? [
        { key: 'totalPRs', label: 'Total PRs', value: analytics.totalPRs.toLocaleString() },
        {
          ...
          value: analytics.issuesDetected.toLocaleString(),
        },
        {
          key: 'securityWarnings',
          label: 'Security Warnings',
          value: analytics.securityWarnings,
        },
        {
          key: 'performanceWarnings',
          label: 'Performance Warnings',
          value: analytics.performanceWarnings,
        },
        {
          key: 'avgResponseTime',
        ...
        },
        {
          ...
          value: analytics.autoFixes.toLocaleString(),
        },
      ]
    : []
