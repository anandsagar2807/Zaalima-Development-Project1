...
import { GitPullRequest, AlertTriangle, Filter, Search, RefreshCw } from "lucide-react"
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">
                        View and manage reviewed pull requests
                    </p>
                </div>
                <button
                    onClick={() => {
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-amber-600 dark:text-amber-400">{stats.withAutofix}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 mt-2">
                                                    ...
                                                    <span className={`px-2 py-0.5 rounded text-xs border ${severityColors[pr.severity]}`}>
                                                        {pr.severity}
                                                    </span>
                                                    {pr.hasAutoFix && (
